...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["LMAO Roblox Moment", "Beat the Demo Week on Hard with no Misses.", 'weekD_nomiss', false],
		["Stay Voiceless", "Beat the Secret Week on Hard with no Misses.",	'weekTD_nomiss', true],
	];
